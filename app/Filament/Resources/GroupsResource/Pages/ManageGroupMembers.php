...
class ManageGroupMembers extends ManageRelatedRecords
{
    ...
    {
        return "Manage Members - {$this->getRecord()->name}";
    }
        ...
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\IconColumn::make("isBlocked")
                    ...
                    ->boolean()
                    ->color(
                        fn(bool $state): string => (bool) $state
                            ? "success"
                            : "danger",
                    ),
            ...
            ->filters([
                ...
                Tables\Filters\TernaryFilter::make("isMuted")->label(
                    "Muted Status",
                ),

                Tables\Filters\TernaryFilter::make("isBlocked")->label(
                    "Blocked Status",
                ),
            ])
            ->headerActions([
            ...
            ->actions([
                ...
                Tables\Actions\Action::make("block")
                    ...
                    ->visible(
                        fn(
                            GroupMember $record,
                        ): bool => !(bool) $record->isBlocked,
                    )
                    ->requiresConfirmation()
                    ->modalHeading("Block Member")
                    ->modalDescription(
                        "Are you sure you want to block this member? They will not be able to participate in the group.",
                    )
                ...
                Tables\Actions\Action::make("unblock")
                    ...
                    ->modalDescription(
                        "Are you sure you want to unblock this member? They will be able to participate in the group again.",
                    )
                    ->action(function (GroupMember $record): void {
                ...
                Tables\Actions\BulkActionGroup::make([
                    ...
                    Tables\Actions\BulkAction::make("unblock_selected")
                        ...
                        ->action(function (
                            ...
                            Notification::make()
                                ->title(
                                    "Selected members unblocked successfully",
                                )
                                ->success()
                                ->send();
                        }),
