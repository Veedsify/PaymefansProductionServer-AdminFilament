                                            ...
                                            @if($isImage)
                                                ...
                                                <div class="relative group">
                                                    <img src="{{ $attachmentUrl }}"
                                                        alt="{{ $attachmentName }}"
                                                        class="attachment-image shadow-sm aspect-square"
                                                        onclick="window.open('{{ $attachmentUrl }}', '_blank')"
                                                        loading="lazy"
                                                        style="{{ count($attachments) > 1 ? 'max-height: 200px; object-fit: cover;' : 'max-height: 400px;' }}">
                                            ...
                                            @elseif($isVideo)
                                                ...
                                                @if($isCloudflareStream)
                                                    ...
                                                    <div class="relative overflow-hidden attachment-video">
                                                        <video class="w-full h-auto {{ count($attachments) > 1 ? 'max-h-48' : 'max-h-96' }}"
                                                            controls
                                                            preload="metadata"
                                                            @if($posterUrl) poster="{{ $posterUrl }}" @endif
                                                            data-hls-url="{{ $attachmentUrl }}">
