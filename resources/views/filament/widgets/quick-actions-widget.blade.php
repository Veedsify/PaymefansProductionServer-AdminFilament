        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            @foreach($this->getViewData()['actions'] as $action)
                <div class="relative">
                    <a
                        href="{{ $action['url'] }}"
                        class="flex items-center p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200 group"
                    >
