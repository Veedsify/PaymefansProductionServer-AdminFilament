            ...
            <div class="bg-white rounded-lg shadow-sm">
                ...
                <div class="p-6">
                    ...
                    <div x-show="$wire.activeTab === 'notifications'">
                        ...
                        <div class="space-y-4">
                            <div class="p-4 bg-cyan-50 border-l-4 border-cyan-400 rounded-r-md">
                                <div class="flex justify-between">
                                    <h4 class="text-sm font-medium text-cyan-800">System Notification</h4>
                                    <span class="text-xs text-cyan-600">Just now</span>
                                </div>
                                <p class="mt-1 text-sm text-cyan-700">Your account has been verified successfully.</p>
                            </div>

                            <div class="p-4 bg-gray-50 border-l-4 border-gray-400 rounded-r-md">
                                <div class="flex justify-between">
                                    <h4 class="text-sm font-medium text-gray-800">Payment Successful</h4>
                                    <span class="text-xs text-gray-600">2 days ago</span>
                                </div>
                                <p class="mt-1 text-sm text-gray-700">Your payment for Premium Annual Plan has been
                                    processed successfully.</p>
                            </div>

                            <div class="p-4 bg-gray-50 border-l-4 border-gray-400 rounded-r-md">
                                <div class="flex justify-between">
                                    <h4 class="text-sm font-medium text-gray-800">New Login</h4>
                                    <span class="text-xs text-gray-600">1 week ago</span>
                                </div>
                                <p class="mt-1 text-sm text-gray-700">We detected a new login to your account from New
                                    York,
                                    USA using Chrome on Windows.</p>
                            </div>
                        </div>
