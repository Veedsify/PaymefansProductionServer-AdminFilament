    ...
    <div style="box-shadow: 0 0 #0000, 0 0 #0000, 0 1px 2px 0 rgb(0 0 0 / 0.05);"
        ...
        <div class="pr-4 h-[474px]" style="min-width: 100%; display: table;">
            ...
            <div class="flex gap-3 my-4 text-gray-600 text-sm flex-1"><span
                ...
                <p class="leading-relaxed"><span class="block font-bold text-gray-700">AI </span>Hi, how can I help you
                    today?
                </p>
            </div>
            ...
            <div class="flex gap-3 my-4 text-gray-600 text-sm flex-1"><span
                ...
                <p class="leading-relaxed"><span class="block font-bold text-gray-700">AI </span>Sorry, I couldn't find
                    any
        ...
        <div class="flex items-center pt-0">
            <form class="flex items-center justify-center w-full space-x-2 gap-2">
                <input
                    class="flex h-10 w-full rounded-md border border-[#e5e7eb] px-3 py-4 text-sm placeholder-[#6b7280] focus:outline-none focus:ring-2 focus:ring-[#9ca3af] disabled:cursor-not-allowed disabled:opacity-50 text-[#030712] focus-visible:ring-offset-2"
                    placeholder="Type your message" value="">
                <button
                    class="inline-flex items-center justify-center rounded-md text-sm font-medium text-white disabled:pointer-events-none disabled:opacity-50 bg-black hover:bg-[#111827E6] h-10 px-4 py-4">
                    Send</button>
            </form>
        </div>
    </div>
